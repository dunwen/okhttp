...
public class OkHttpClient implements Cloneable, Call.Factory {
  ...
  public static final class Builder {
     ...
     * HTTP代理：能够代理客户机的HTTP访问，主要是代理浏览器访问网页，它的端口一般为80、8080、3128等；
     ...
     而SOCKS5代理则既支持TCP协议又支持UDP协议（即用户数据包协议），
     还支持各种身份验证机制、服务器端域名解析等。SOCK4能做到的SOCKS5都可得到，
     但SOCKS5能够做到的SOCK4则不一定能做到，比如我们常用的聊天工具QQ在使用代理时就要求用SOCKS5代理，因为它需要使用UDP协议来传输数据
     *
     */
     ...
     *
     * 设置这个玩意可以实现cookie操作，保存和代理，可以决定接受哪个cookie 不接收哪个等等
     * */
    ...
    /** 这个人家说不应该在应用实现这个接口惹 >>OkHttp's internal cache interface. Applications shouldn't implement this: instead use {@link
     * okhttp3.Cache*/
